...
(function($) {
	...
	var defaults = {
		...
		show_randomly: 			false,
		thumbs: 				false,
		animateNumberOut: 		{backgroundColor:'#bfbfc0', color:'#fff'},
		animateNumberOver: 		{backgroundColor:'#fff', color:'#bfbfc0'},
		animateNumberActive: 	{backgroundColor:'#fc7ca3', color:'#fff'},
		hideTools: 				false,
		fullscreen: 			false,
		xml: 					false,
		dots: 					false,
		...
		setup: function() 
		{
			...
			else 
			{
				...
				switch (self.settings.numbers_align) {
					...
					case 'left' : 
						self.box_skitter.find(class_info).css({'left':'320px'});
						break;
				}
