ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :looks, :only => [:index, :show]

  map.resources :cart_items, :as => 'cart', :member => {:add_voucher => :post,:select_delivery_option => :post, :disjoin_voucher => :get}
  ...
  map.namespace :admin do |admin|
    ...
    admin.resources :products, :except => :show, :collection => {:addimages => :get,:top100 => :get, :display_order => [:get, :post],:in_place_edit=>:any} do |products|
