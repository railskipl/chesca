...
class Product < ActiveRecord::Base
  ...
  has_and_belongs_to_many :related_products,  :class_name => 'Product', :association_foreign_key => 'related_product_id', :after_add => :add_inverse, :after_remove => :remove_inverse, :conditions => { :visible => true }
  ...
  has_many :looks, :through => :product_look
